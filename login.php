...
<div id="body">
<div class="landing-page"><div class="form-appointment"><div class="wpcf7" id="wpcf7-f560-p590-o1"><form action="login.php" method="post" class="wpcf7-form" novalidate="novalidate" _lpchecked="1">
<form>
<div class="group">
...
<input name="" type="submit" value="Login" class="login login-submit"> <span style="display:inline-block; width: 110;"></span><a href="passwdreset.php" style="text-decoration:none">Forgot Password ?</a> </div>
</form>
</div>
</div>
